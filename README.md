...
Retrieval
Relevant portfolio projects are retrieved from a vector database (ChromaDB) based on job skills.

Augmentation
Retrieved portfolio links are injected into the LLM prompt.

Generation
The LLM generates a grounded, personalized cold email using retrieved data.
...
Create .env inside App/resource/:
